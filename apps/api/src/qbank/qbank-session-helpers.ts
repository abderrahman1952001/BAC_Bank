...
export type PracticeSessionExamOffering = {
  id: string;
  year: number;
...
export type PracticeSessionExerciseCandidate = {
  ...
  sourceExam: PracticeSessionExamOffering;
  examOfferings: PracticeSessionExamOffering[];
...
export function buildPracticeSearchCorpus(
...
export function toPracticeSessionExamOffering<
  T extends {
    id: string;
    year: number;
    sessionType: SessionType;
...
>(exam: T): PracticeSessionExamOffering {
  return {
    id: exam.id,
    year: exam.year,
...
export function pushPracticeSessionExamOffering(
  offerings: PracticeSessionExamOffering[],
  exam: PracticeSessionExamOffering,
) {
...
export function sortPracticeSessionExamOfferings<
  T extends PracticeSessionExamOffering,
>(offerings: T[]) {
...
>(offerings: T[]) {
  return sortPracticeSessionExamOfferings(offerings)[0] ?? null;
}
