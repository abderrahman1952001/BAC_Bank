...
export default async function StudentElectricalControlLogicWorkbenchPage({
  searchParams,
}: {
  ...
  const missionItem = missionId
    ? await fetchServerLabToolMissions("technology-electrical-control-logic")
        .then(
          (payload) =>
  ...
  return (
    <StructuredLabWorkbench
      ...
      toolId="technology-electrical-control-logic"
      missionItem={missionItem}
      fallbackPreset={electricalControlLogicWorkbenchPresets[0]}
    />
  );
}
