...
export default async function StudentProcessReactionWorkbenchPage({
  searchParams,
}: {
  ...
  const missionItem = missionId
    ? await fetchServerLabToolMissions("technology-process-reaction-workbench")
        .then(
          (payload) =>
  ...
  return (
    <StructuredLabWorkbench
      ...
      toolId="technology-process-reaction-workbench"
      missionItem={missionItem}
      fallbackPreset={processReactionWorkbenchPresets[0]}
    />
  );
}
