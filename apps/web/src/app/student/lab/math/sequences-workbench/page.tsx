import { MathSequencesWorkbenchLab } from "@/components/math-sequences-workbench-lab";
...
export default async function StudentMathSequencesWorkbenchPage({
  searchParams,
}: {
  ...
  const missionItem = missionId
    ? await fetchServerLabToolMissions("math-sequences-workbench")
        .then(
          (payload) =>
