import { SvtDocumentWorkbenchLab } from "@/components/svt-document-workbench-lab";
...
export default async function StudentSvtDocumentWorkbenchPage({
  searchParams,
}: {
  ...
  const missionItem = missionId
    ? await fetchServerLabToolMissions("svt-document-workbench")
        .then(
          (payload) =>
