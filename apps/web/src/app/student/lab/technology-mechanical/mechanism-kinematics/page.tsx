...
export default async function StudentMechanicalMechanismKinematicsPage({
  searchParams,
}: {
  ...
  return (
    <StructuredLabWorkbench
      ...
      toolId="technology-mechanical-mechanism-kinematics"
      missionItem={missionItem}
      fallbackPreset={mechanicalMechanismKinematicsWorkbenchPresets[0]}
    />
  );
}
