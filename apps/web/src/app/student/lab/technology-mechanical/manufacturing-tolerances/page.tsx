...
export default async function StudentMechanicalManufacturingTolerancesPage({
  searchParams,
}: {
  ...
  return (
    <StructuredLabWorkbench
      ...
      toolId="technology-mechanical-manufacturing-tolerances"
      missionItem={missionItem}
      fallbackPreset={mechanicalManufacturingTolerancesWorkbenchPresets[0]}
    />
  );
}
