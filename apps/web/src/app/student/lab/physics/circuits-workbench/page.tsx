...
export default async function StudentPhysicsCircuitsWorkbenchPage({
  searchParams,
}: {
  ...
  const missionItem = missionId
    ? await fetchServerLabToolMissions("physics-circuits-workbench")
        .then(
          (payload) =>
  ...
  return (
    <StructuredLabWorkbench
      ...
      toolId="physics-circuits-workbench"
      missionItem={missionItem}
      fallbackPreset={physicsCircuitsWorkbenchPresets[0]}
    />
  );
}
