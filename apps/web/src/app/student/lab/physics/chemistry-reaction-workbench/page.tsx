...
export default async function StudentPhysicsChemistryReactionWorkbenchPage({
  searchParams,
}: {
  ...
  const missionItem = missionId
    ? await fetchServerLabToolMissions("physics-chemistry-reaction-workbench")
        .then(
          (payload) =>
  ...
  return (
    <StructuredLabWorkbench
      ...
      toolId="physics-chemistry-reaction-workbench"
      missionItem={missionItem}
      fallbackPreset={physicsChemistryReactionWorkbenchPresets[0]}
    />
  );
}
