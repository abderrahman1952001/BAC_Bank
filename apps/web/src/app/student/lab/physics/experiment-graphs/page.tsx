...
export default async function StudentPhysicsExperimentGraphsPage({
  searchParams,
}: {
  ...
  const missionItem = missionId
    ? await fetchServerLabToolMissions("physics-experiment-graphs")
        .then(
          (payload) =>
  ...
  return (
    <StructuredLabWorkbench
      ...
      toolId="physics-experiment-graphs"
      missionItem={missionItem}
      fallbackPreset={physicsExperimentGraphPresets[0]}
    />
  );
}
